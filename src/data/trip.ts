...
export const tripDays: TripDay[] = [
  {
    ...
    weekday: "Friday",
    location: "Paris",
    tagline: "Tanya heads out first",
    description: "Tanya catches a flight to Paris at 1:45 PM. A quick overnight before heading south to Portugal.",
    image: "/images/paris.webp",
    stops: [
      { name: "Tanya: Flight to Paris", type: "transport" },
    ],
  },
  {
    date: "April 12",
    weekday: "Saturday",
    location: "Everyone to Lisbon",
    tagline: "Converging from two continents",
    description: "Tanya flies from Paris to Lisbon. Meanwhile, Garrett and Alsu fly from Los Angeles to Lisbon. Everyone arrives and the adventure officially starts!",
    image: "/images/lisbon-arrival.webp",
    stops: [
      { name: "Tanya: Paris to Lisbon", type: "transport" },
      { name: "Garrett & Alsu: Los Angeles to Lisbon", type: "transport" },
    ],
  },
  {
    date: "April 13",
